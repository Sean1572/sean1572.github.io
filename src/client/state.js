...
export function getCurrentState() {
  ...
  if (base < 0 || base === gameUpdates.length - 1) {
    ...
    return {
      ...
      roundManger: interpolateObject(baseUpdate.roundManger, next.roundManger, ratio),
      others: interpolateObjectArray(baseUpdate.others, next.others, ratio),
      cards: interpolateObjectArray(baseUpdate.cards, next.cards, ratio),
      cardsSignals: interpolateObjectArray(baseUpdate.cardsSignals, next.cardsSignals, ratio),
    };
  }
}
